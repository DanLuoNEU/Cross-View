...
# 03/08/2022, Dan
# Bug: 
# 1. fix Drr_Dict/Dtheta_Dict bug, 
...
def weightPoles(path_exp, num_used_top=10, dim_data_draw=0,
    ...
    dir_save = os.path.join(path_exp,'20220308_DictB-ArmJoints_rThetaFixed')
    ...
    for id_act in range(len(list_mat_bin[0][1]['bi_action'][0])):
        for name_joint, index_joint in dict_arm.items():
            ...
            for name_view,mat_bin in list_mat_bin:
                ...
                # if id_act==0: continue
                bi_action_act=mat_bin['bi_action'][0,id_act].squeeze()
            ...
            figs_dict_joint.savefig(os.path.join(dir_save, f'Act{id_act+1}-{name_joint}_{num_seqs*num_clips}clips.png'), dpi=400)
