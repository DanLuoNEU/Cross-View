...
name_exp="20220314_1_comp_A1V2V3-A6V2V3-V3A1A6_rThetaFixed_legend"
...
def plot_subplot(mat_data, id_act, name_view, index_joint, id_dim_data, mk, c,
    ...
    bi_action_act=mat_data['coeff_action'][0,id_act].squeeze()
...
def weightPoles(path_exp, num_used_top=10, dim_data_draw=0,
    ...
    dir_save = os.path.join(path_exp,name_exp)
