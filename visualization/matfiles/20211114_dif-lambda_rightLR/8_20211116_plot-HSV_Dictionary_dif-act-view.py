...
def weightPoles(path_exp,  
    ...
    Output:
        ...
        Suppose .mat file contain:
            ...
            Improved DYAN Dictionary
                ...
                for each pole,
                    weight_c = |c| = |C_1-jC_2|
        num_used_top:   Mostly used i poles
        dim_data_draw:  the dimention for data to draw
    '''
    ...
    for name_bin in list_name_bin:
        ...
        for id_plot_bin in range(RGB_Gumbel.shape[0]):
            axs_bin.set_title(name_bin.split('.')[0]+f'_{id_plot_bin}', fontsize=12)
