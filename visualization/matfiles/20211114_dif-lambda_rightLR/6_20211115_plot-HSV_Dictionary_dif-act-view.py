...
def weightPoles(path_exp,  
    ...
    for name_bin in list_name_bin:
        ...
        # zeros = np.zeros_like(bin_gumbel)
        
        # HSV_gumbel = np.expand_dims(zeros, axis=3)
        ...
        #         HSV_gumbel[dim_HSV_0, 1:81, dim_HSV_1, 1],HSV_gumbel[dim_HSV_0, 81:, dim_HSV_1, 2] = 1 # S
        #         HSV_gumbel[dim_HSV_0, 1:81, dim_HSV_1, 1],HSV_gumbel[dim_HSV_0, 81:, dim_HSV_1, 1]=np.squeeze(Drr_Dict), np.squeeze(Drr_Dict) # S
        #         HSV_gumbel[dim_HSV_0, 1:81, dim_HSV_1, 0],HSV_gumbel[dim_HSV_0, 81:, dim_HSV_1, 0]=np.squeeze(Dtheta_Dict), np.squeeze(-Dtheta_Dict) # H

        # RGB_gumble = colorsys.hsv_to_rgb(HSV_gumbel)
        # RGB_mask_gumble = RGB_gumbel *  np.repeat(np.expand_dims(bin_gumbel, axis=3), 3, axis=3)
        ...
        for dim_HSV_0 in range(HSV_gumbel.shape[0]):
            for dim_HSV_1 in range(HSV_gumbel.shape[2]):
                HSV_gumbel[dim_HSV_0, 1:81, dim_HSV_1, 1],HSV_gumbel[dim_HSV_0, 81:, dim_HSV_1, 1]=np.squeeze(Drr_Dict), np.squeeze(Drr_Dict) # S
                HSV_gumbel[dim_HSV_0, 1:81, dim_HSV_1, 0],HSV_gumbel[dim_HSV_0, 81:, dim_HSV_1, 0]=np.squeeze(Dtheta_Dict/(2*np.pi)), np.squeeze(2*np.pi-Dtheta_Dict) # H
        ...
        #             if RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,0]>1:   RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,0]=1
        #             elif RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,0]<0: RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,0]=0
        #             if RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,1]>1:   RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,1]=1
        #             elif RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,1]<0: RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,1]=0
        #             if RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,2]>1:   RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,2]=1
        #             elif RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,2]<0: RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2,2]=0
                    
        #             HEX_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2]=int((matplotlib.colors.to_hex(RGB_gumbel[dim_HSV_0,dim_HSV_1,dim_HSV_2])).replace('#','0x'),16)
        
        # im_bin=axs_bin.imshow(HEX_gumbel[0,].transpose(), interpolation='none')
        for id_plot_bin in range(RGB_Gumbel.shape[0]):
            ...
            if draw_bin:
                figs_bin.savefig(os.path.join(path_exp, f"binary-code-{name_bin.split('.')[0]}_{id_plot_bin}.png"), dpi=400)
