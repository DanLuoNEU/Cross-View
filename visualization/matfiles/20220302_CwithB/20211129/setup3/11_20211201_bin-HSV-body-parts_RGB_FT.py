# This file is used to draw all Binary Codes HSV binarization for setup3
# 12/01/2021, Dan
...
dir_default='/home/dan/ws/2021-CrossView/matfiles/1129/setup3'
    ...
    for name_bin in list_name_C_B:
        ...
        for id_act in range(len(mat_bin['bi_action'][0])):
            ...
            for id_vid in range(bi_action_act.shape[0]):
                bin_gumbel = np.squeeze(bi_action_act[id_vid]) # 6,1,85,50
