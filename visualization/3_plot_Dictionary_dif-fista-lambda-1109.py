...
def weightPoles(path_exp, theta_max_pi=False, num_used_top=30, dims_data_draw=0, 
...
def main():
    ...
    weightPoles(path_exp, theta_max_pi=True, num_used_top=30, dims_data_draw=3, 
                weight_complex=False, draw_dict=False, draw_traj=True, draw_pole=True)
