...
class NUCLA_viewProjection(tudata.Dataset):
    ...
    def __init__(self, root_list, dataType, clip, phase, cam, T, target_view='view_1', project_view='view_2', test_view='view_3'):
        ...
        if self.phase == 'test':
            ...
            # self.samples_list = random.sample(temp, 10)

            self.samples_list = temp[230:250]
            # self.samples_list = temp[50:100]
    ...
    def get_data_multi(self, view, name_sample):
        ...
        if self.dataType == '2D':
            skeleton, usedID = getJsonData(os.path.join(self.root_skeleton, view), name_sample)
            # imageSequence = imageSequence[usedID]
            imageSequence = imageSequence_orig[usedID]
        ...
        return allSkeletons, allImageSequence, allHeatMaps, T_sample
    ...
    def __getitem__(self, index):
        ...
        if self.phase == 'test':
            ...
            if self.clip == 'Single':
                ...
                testView_multiSkeletons,testView_multiImage, testView_heat, T_sample = self.get_data_multi(view, name_sample)
                ...
                dicts = {'input_skeleton':testView_multiSkeletons, 'input_image':testView_multiImage,'input_velocity':testVelocity,
                        'testView_heat':testView_heat,'action': label_action, 'sample_name':name_sample, 'videoL':T_sample}
            ...
            if self.clip == 'Single':
                ...
                projectView_multiSkeleton, projectView_multiImage, projectView_heat, T_sample = self.get_data_multi(self.project_view, name_sample_v1)
                targetView_multiSkeleton, targetView_multiImage, targetView_heat, T_sample = self.get_data_multi(self.target_view, name_sample_v2)
