...
class NTURGBD_viewProjection(data.Dataset):
    ...
    def __init__(self, root_skeleton, root_list, nanList, dataType,clip, phase, T, target_view, project_view, test_view):
        ...
        for item in target_txt:
            if item[0] + '.skeleton.npy' not in self.nanList:
...
if __name__ == "__main__":
    ...
    DS = NTURGBD_viewProjection(root_skeleton="/data/NTU-RGBD/poses",
                 root_list="/data/Yuexi/NTU-RGBD/list/",nanList=nanList, dataType='2D', clip='Multi',
